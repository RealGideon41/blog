    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('posts.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="4" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
            </div>
